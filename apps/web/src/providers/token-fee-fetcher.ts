...
import { TokenFeeDetector } from "types/smart-router/types/other/TokenFeeDetector";
import { TokenFeeDetector__factory } from "types/smart-router/types/other/factories/TokenFeeDetector__factory";
