...
import { useLegacyV3NFTPositionManagerContract, useV3NFTPositionManagerContract } from './useContract'
...
function useLegacyV3PositionsFromTokenIds(
  tokenIds: BigNumber[] | undefined,
): UseV3PositionsResults {
  const positionManager = useLegacyV3NFTPositionManagerContract();
...
export function useLegacyV3Positions(
  ...
  const { positions, loading: positionsLoading } =
    useLegacyV3PositionsFromTokenIds(tokenIds);
